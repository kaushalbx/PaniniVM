...
- 295 implemented sūtras out of the 3,959-rule target.
...
- Complete representative `LOT` and `LING` paradigms in both padas across all
  ten gaṇas, including class-specific strong and weak stems.
