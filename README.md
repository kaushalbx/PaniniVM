...
- **454 registered executable sūtras** out of the 3,959-rule target (3,505 remaining).
...
- **Sanādyanta & Kṛdanta Derived Formations**: Desiderative (*san*), Intensive (*yaṅ*), Causative (*ṇic*), Periphrastic Liṭ (*ām*), Kṛtya affixes (*yat*, *ṇyat*, *tavyat*, *anīyar*), Agent affixes (*ṇvul*, *tṛc*, *ka*, *ṣvun*), Participles (*śatṛ*, *śānac*), and zero-affixes (*kvip*).
