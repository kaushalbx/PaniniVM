...
class TingantaEngineTest {
    ...
    @Test
    fun `LOT handles vowel consonant irregular and ubhayapada roots`() {
        val expected = listOf(
            Triple("णीञ्", PadaType.PARASMAIPADA, "नयतु नयताम् नयन्तु नय नयतम् नयत नयानि नयाव नयाम"),
            Triple("णीञ्", PadaType.ATMANEPADA, "नयताम् नयेताम् नयन्ताम् नयस्व नयेथाम् नयध्वम् नयै नयावहै नयामहै"),
            Triple("डुपचँष्", PadaType.PARASMAIPADA, "पचतु पचताम् पचन्तु पच पचतम् पचत पचानि पचाव पचाम"),
            Triple("डुपचँष्", PadaType.ATMANEPADA, "पचताम् पचेताम् पचन्ताम् पचस्व पचेथाम् पचध्वम् पचै पचावहै पचामहै"),
            Triple("गमॢँ", PadaType.PARASMAIPADA, "गच्छतु गच्छताम् गच्छन्तु गच्छ गच्छतम् गच्छत गच्छानि गच्छाव गच्छाम"),
            Triple("स्रन्भुँ", PadaType.PARASMAIPADA, "स्रम्भतु स्रम्भताम् स्रम्भन्तु स्रम्भ स्रम्भतम् स्रम्भत स्रम्भानि स्रम्भाव स्रम्भाम"),
            Triple("स्रन्भुँ", PadaType.ATMANEPADA, "स्रम्भताम् स्रम्भेताम् स्रम्भन्ताम् स्रम्भस्व स्रम्भेथाम् स्रम्भध्वम् स्रम्भै स्रम्भावहै स्रम्भामहै"),
        )

        expected.forEach { (root, pada, surfaces) ->
            TingantaEngine().deriveSupportedParadigm(root, pada, Lakara.LOT).assertSurfaces(surfaces)
        }

        TingantaEngine().deriveSupportedParadigm("गमॢँ", lakara = Lakara.LOT).forms.values.forEach { result ->
            assertTrue(result.applications.map { it.sutra }.containsAll(setOf("7.3.77", "6.1.73", "8.4.40")))
        }
    }

    @Test
    fun `LANG handles vowel consonant irregular and ubhayapada roots`() {
        val expected = listOf(
            Triple("णीञ्", PadaType.PARASMAIPADA, "अनयत् अनयताम् अनयन् अनयः अनयतम् अनयत अनयम् अनयाव अनयाम"),
            Triple("णीञ्", PadaType.ATMANEPADA, "अनयत अनयेताम् अनयन्त अनयथाः अनयेथाम् अनयध्वम् अनये अनयावहि अनयामहि"),
            Triple("डुपचँष्", PadaType.PARASMAIPADA, "अपचत् अपचताम् अपचन् अपचः अपचतम् अपचत अपचम् अपचाव अपचाम"),
            Triple("डुपचँष्", PadaType.ATMANEPADA, "अपचत अपचेताम् अपचन्त अपचथाः अपचेथाम् अपचध्वम् अपचे अपचावहि अपचामहि"),
            Triple("गमॢँ", PadaType.PARASMAIPADA, "अगच्छत् अगच्छताम् अगच्छन् अगच्छः अगच्छतम् अगच्छत अगच्छम् अगच्छाव अगच्छाम"),
            Triple("स्रन्भुँ", PadaType.PARASMAIPADA, "अस्रम्भत् अस्रम्भताम् अस्रम्भन् अस्रम्भः अस्रम्भतम् अस्रम्भत अस्रम्भम् अस्रम्भाव अस्रम्भाम"),
            Triple("स्रन्भुँ", PadaType.ATMANEPADA, "अस्रम्भत अस्रम्भेताम् अस्रम्भन्त अस्रम्भथाः अस्रम्भेथाम् अस्रम्भध्वम् अस्रम्भे अस्रम्भावहि अस्रम्भामहि"),
        )

        expected.forEach { (root, pada, surfaces) ->
            TingantaEngine().deriveSupportedParadigm(root, pada, Lakara.LANG).assertSurfaces(surfaces)
        }

        TingantaEngine().deriveSupportedParadigm("गमॢँ", lakara = Lakara.LANG).forms.values.forEach { result ->
            assertTrue(result.applications.map { it.sutra }.containsAll(setOf("7.3.77", "6.1.73", "8.4.40")))
        }
    }

    @Test
    fun `LING handles vowel consonant irregular and ubhayapada roots`() {
        val expected = listOf(
            Triple("णीञ्", PadaType.PARASMAIPADA, "नयेत् नयेताम् नयेयुः नयेः नयेतम् नयेत नयेयम् नयेव नयेम"),
            Triple("णीञ्", PadaType.ATMANEPADA, "नयेत नयेयाताम् नयेरन् नयेथाः नयेयाथाम् नयेध्वम् नयेय नयेवहि नयेमहि"),
            Triple("डुपचँष्", PadaType.PARASMAIPADA, "पचेत् पचेताम् पचेयुः पचेः पचेतम् पचेत पचेयम् पचेव पचेम"),
            Triple("डुपचँष्", PadaType.ATMANEPADA, "पचेत पचेयाताम् पचेरन् पचेथाः पचेयाथाम् पचेध्वम् पचेय पचेवहि पचेमहि"),
            Triple("गमॢँ", PadaType.PARASMAIPADA, "गच्छेत् गच्छेताम् गच्छेयुः गच्छेः गच्छेतम् गच्छेत गच्छेयम् गच्छेव गच्छेम"),
            Triple("स्रन्भुँ", PadaType.PARASMAIPADA, "स्रम्भेत् स्रम्भेताम् स्रम्भेयुः स्रम्भेः स्रम्भेतम् स्रम्भेत स्रम्भेयम् स्रम्भेव स्रम्भेम"),
            Triple("स्रन्भुँ", PadaType.ATMANEPADA, "स्रम्भेत स्रम्भेयाताम् स्रम्भेरन् स्रम्भेथाः स्रम्भेयाथाम् स्रम्भेध्वम् स्रम्भेय स्रम्भेवहि स्रम्भेमहि"),
        )

        expected.forEach { (root, pada, surfaces) ->
            TingantaEngine().deriveSupportedParadigm(root, pada, Lakara.LING).assertSurfaces(surfaces)
        }

        TingantaEngine().deriveSupportedParadigm("गमॢँ", lakara = Lakara.LING).forms.values.forEach { result ->
            assertTrue(result.applications.map { it.sutra }.containsAll(setOf("7.3.77", "6.1.73", "8.4.40")))
        }
    }

    @Test
    fun `LRT handles vowel consonant irregular and ubhayapada roots`() {
        val expected = listOf(
            Triple("णीञ्", PadaType.PARASMAIPADA, "नेष्यति नेष्यतः नेष्यन्ति नेष्यसि नेष्यथः नेष्यथ नेष्यामि नेष्यावः नेष्यामः"),
            Triple("णीञ्", PadaType.ATMANEPADA, "नेष्यते नेष्येते नेष्यन्ते नेष्यसे नेष्येथे नेष्यध्वे नेष्ये नेष्यावहे नेष्यामहे"),
            Triple("डुपचँष्", PadaType.PARASMAIPADA, "पक्ष्यति पक्ष्यतः पक्ष्यन्ति पक्ष्यसि पक्ष्यथः पक्ष्यथ पक्ष्यामि पक्ष्यावः पक्ष्यामः"),
            Triple("डुपचँष्", PadaType.ATMANEPADA, "पक्ष्यते पक्ष्येते पक्ष्यन्ते पक्ष्यसे पक्ष्येथे पक्ष्यध्वे पक्ष्ये पक्ष्यावहे पक्ष्यामहे"),
            Triple("गमॢँ", PadaType.PARASMAIPADA, "गमिष्यति गमिष्यतः गमिष्यन्ति गमिष्यसि गमिष्यथः गमिष्यथ गमिष्यामि गमिष्यावः गमिष्यामः"),
            Triple("स्रन्भुँ", PadaType.PARASMAIPADA, "स्रम्भिष्यति स्रम्भिष्यतः स्रम्भिष्यन्ति स्रम्भिष्यसि स्रम्भिष्यथः स्रम्भिष्यथ स्रम्भिष्यामि स्रम्भिष्यावः स्रम्भिष्यामः"),
            Triple("स्रन्भुँ", PadaType.ATMANEPADA, "स्रम्भिष्यते स्रम्भिष्येते स्रम्भिष्यन्ते स्रम्भिष्यसे स्रम्भिष्येथे स्रम्भिष्यध्वे स्रम्भिष्ये स्रम्भिष्यावहे स्रम्भिष्यामहे"),
        )

        expected.forEach { (root, pada, surfaces) ->
            TingantaEngine().deriveSupportedParadigm(root, pada, Lakara.LRT).assertSurfaces(surfaces)
        }

        TingantaEngine().deriveSupportedParadigm("गमॢँ", lakara = Lakara.LRT).forms.values.forEach { result ->
