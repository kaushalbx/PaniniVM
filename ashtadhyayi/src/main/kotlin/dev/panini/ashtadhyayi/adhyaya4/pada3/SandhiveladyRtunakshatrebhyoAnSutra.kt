...
object SandhiveladyRtunakshatrebhyoAnSutra : Sutra<DerivationState, DerivationChange>(
    ...
    override fun apply(context: DerivationState) = DerivationChange(context.addTerm(DerivationTerm("an-suffix", "अण्", TermKind.PRATYAYA, upadesha = "अण्", itProcessingPhase = dev.panini.derivation.ItProcessingPhase.RAW_UPADESHA)), "4.3.16 introduces अण् after an eligible संधिवेलादि time expression.")
}
