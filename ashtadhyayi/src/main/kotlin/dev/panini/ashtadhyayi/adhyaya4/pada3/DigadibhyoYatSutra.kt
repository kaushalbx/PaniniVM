...
object DigadibhyoYatSutra : Sutra<DerivationState, DerivationChange>(
    ...
    override fun apply(context: DerivationState) = DerivationChange(context.addTerm(DerivationTerm("yat-suffix", "यत्", TermKind.PRATYAYA, upadesha = "यत्", itProcessingPhase = dev.panini.derivation.ItProcessingPhase.RAW_UPADESHA)), "4.3.54 introduces यत् after an eligible दिगादि term in the tatra-bhava sense.")
}
