...
/**
 * Sūtra 3.4.115 लिट् च.
 * Assigns Ārdhadhātuka saṃjñā to Liṭ affixes.
 */
object LitCaSutra : Sutra<DerivationState, DerivationChange>(
    number = "3.4.115", text = "लिट् च",
    hindiExplanation = "लिट् लकार के स्थान पर विहित प्रत्ययों की भी 'आर्धधातुक' संज्ञा होती है।",
    type = SutraType.SAMJNA, chapter = 3, pada = 4, optional = false, kramaValue = 340115,
    ...
    override fun apply(context: DerivationState): DerivationChange {
        ...
        return DerivationChange(
            ...
            explanation = "3.4.115 assigns Ārdhadhātuka saṃjñā to Liṭ affixes.",
        )
    }
}
