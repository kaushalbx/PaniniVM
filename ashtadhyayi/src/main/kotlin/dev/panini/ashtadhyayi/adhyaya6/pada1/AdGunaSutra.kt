...
object AdGunaSutra : Sutra<DerivationState, DerivationChange>(
    ...
    override fun matches(context: DerivationState): Boolean {
        ...
        if (rutvaFollowUp != null && context.terms.any { it.id == rutvaFollowUp.targetId && it.surface.endsWith("ु") }) return true
    ...
    override fun apply(context: DerivationState): DerivationChange {
        if (context.substitutions.lastOrNull()?.sutra == "6.1.114") {
            ...
            val target = context.terms.firstOrNull { it.id == targetId && it.surface.endsWith("ु") }
