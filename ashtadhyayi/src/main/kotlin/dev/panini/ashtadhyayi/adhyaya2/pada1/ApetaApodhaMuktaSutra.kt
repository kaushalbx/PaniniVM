 ...
 *
 * Pañcamī-subanta compounds with 'apeta', 'apoḍha', 'mukta', 'patita', 'apatrasta' in Tatpuruṣa.
 */
object ApetaApodhaMuktaSutra : Sutra<SamasaRuleContext, SamasaRuleResult>(
    number = "2.1.38",
    text = "अपेतापोढमुक्तपतितापत्रस्तैरल्पशः",
    hindiExplanation = "पञ्चम्यन्तः सुबन्तः अपेत, अपोढ, मुक्त, पतित, अपत्रस्त शब्दैः सह समस्यते, सोऽपि तत्पुरुषः।",
