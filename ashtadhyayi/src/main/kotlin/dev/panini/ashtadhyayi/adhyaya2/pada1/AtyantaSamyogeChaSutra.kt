...
object AtyantaSamyogeChaSutra : Sutra<SamasaRuleContext, SamasaRuleResult>(
    ...
    override fun matches(context: SamasaRuleContext): Boolean {
        ...
        return context.samasaType == SamasaType.TATPURUSA &&
            context.purvaPada.vibhakti == dev.panini.core.Vibhakti.DVITIYA &&
    ...
    override fun apply(context: SamasaRuleContext): SamasaRuleResult {
        ...
        return SamasaRuleResult.Formed(
            ...
            explanation = "2.1.29 forms Atyanta-saṁyoga Dvitīyā Tatpuruṣa compound '$compoundStem'.",
        )
    }
}
