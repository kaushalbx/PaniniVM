...
object ShandikadibhyoNyahSutra : Sutra<DerivationState, DerivationChange>(
    ...
    override fun matches(context: DerivationState) = SemanticFeature.ABHIJANA in context.semanticFeatures && context.terms.any { it.kind == TermKind.PRATIPADIKA && GanaPatha.isEligibleMember(118, it.surface, it.lexicalUses) } && context.allEffectiveTerms.none { it.upadesha == "ञ्य" }
