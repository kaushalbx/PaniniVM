...
object DigadibhyoYatSutra : Sutra<DerivationState, DerivationChange>(
    ...
    override fun matches(context: DerivationState) = SemanticFeature.TATRA_BHAVA in context.semanticFeatures && context.terms.any { it.kind == TermKind.PRATIPADIKA && GanaPatha.isEligibleMember(113, it.surface, it.lexicalUses) } && context.allEffectiveTerms.none { it.upadesha == "यत्" }
