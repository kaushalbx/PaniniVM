...
object SandhiveladyRtunakshatrebhyoAnSutra : Sutra<DerivationState, DerivationChange>(
    ...
    override fun matches(context: DerivationState) = SemanticFeature.KALAVRTTI in context.semanticFeatures && context.terms.any { it.kind == TermKind.PRATIPADIKA && GanaPatha.isEligibleMember(112, it.surface, it.lexicalUses) } && context.allEffectiveTerms.none { it.upadesha == "अण्" }
