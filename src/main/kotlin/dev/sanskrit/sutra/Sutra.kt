...
abstract class Sutra<C, R>(
    ...
    val type: SutraType, val chapter: Int, val pada: Int, val optional: Boolean, val kramaValue: Int,
    val avastha: SutraAvastha = SutraAvastha.KRIYAVAT, val role: SutraRole, val action: SutraAction,
