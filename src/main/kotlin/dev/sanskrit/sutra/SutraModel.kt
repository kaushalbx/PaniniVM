...
enum class SutraScope { VARNA, PADA_BOUNDARY, DHATU, PRATYAYA, DERIVATION }
enum class SutraInput { VARNA, PRAHYAHARA, DHATU, PRATIPADIKA, PRATYAYA, IT_MARKER, SAMJNA, SEMANTIC_FEATURE, DERIVATION_STAGE, PRATYAHARA }
