...
enum class SupAffix(
    ...
    SU(Vibhakti.PRATHAMA, Vacana.EKAVACANA, "सुँ"), AU(
        Vibhakti.PRATHAMA,
        Vacana.DVIVACANA,
        Svara.AU.devanagari
    ),
    JAS(
        ...
        Vacana.BAHUVACANA,
        "जस्",
        itMarkers = setOf(ItMarker.J)
    ),
    AM(Vibhakti.DVITIYA, Vacana.EKAVACANA, "अम्"), AUT(
        Vibhakti.DVITIYA, Vacana.DVIVACANA, "औट्"
    ),
    SAS(Vibhakti.DVITIYA, Vacana.BAHUVACANA, "शस्"), TA(
        Vibhakti.TRTIYA,
        Vacana.EKAVACANA,
        "टा"
    ),
    BHYAM_3(
        Vibhakti.TRTIYA, Vacana.DVIVACANA, "भ्याम्"
    ),
    BHIS(Vibhakti.TRTIYA, Vacana.BAHUVACANA, "भिस्"), NGE(
        Vibhakti.CHATURTHI,
        Vacana.EKAVACANA,
        "ङे"
    ),
    BHYAM_4(
        Vibhakti.CHATURTHI, Vacana.DVIVACANA, "भ्याम्"
    ),
    BHYAS_4(Vibhakti.CHATURTHI, Vacana.BAHUVACANA, "भ्यस्"), NGASI(
        Vibhakti.PANCHAMI,
        Vacana.EKAVACANA,
        "ङसि"
    ),
    BHYAM_5(
        Vibhakti.PANCHAMI, Vacana.DVIVACANA, "भ्याम्"
    ),
    BHYAS_5(Vibhakti.PANCHAMI, Vacana.BAHUVACANA, "भ्यस्"), NGAS(
        Vibhakti.SASTHI,
        Vacana.EKAVACANA,
        "ङस्"
    ),
    OS_6(
        Vibhakti.SASTHI, Vacana.DVIVACANA, "ओस्"
    ),
    AM_6(Vibhakti.SASTHI, Vacana.BAHUVACANA, "आम्"), NGI(
        Vibhakti.SAPTAMI,
        Vacana.EKAVACANA,
        "ङि"
    ),
    OS_7(
        Vibhakti.SAPTAMI, Vacana.DVIVACANA, "ओस्"
    ),
    SUP(Vibhakti.SAPTAMI, Vacana.BAHUVACANA, "सुप्");

    val id: String get() = "sup-" + name.lowercase().replace('_', '-')

    fun term(): DerivationTerm =
    ...
    companion object {
        ...
        fun fromFeatures(features: Set<dev.sanskrit.shiksha.SemanticFeature>): SupAffix? {
            ...
            val expectedFeaturesCount = (if (features.contains(dev.sanskrit.shiksha.SemanticFeature.PRATHAMA) ||
                                              ...
                                              features.contains(dev.sanskrit.shiksha.SemanticFeature.SAPTAMI)) 1 else 0) +
                                        (if (features.contains(dev.sanskrit.shiksha.SemanticFeature.EKAVACANA) ||
                                              ...
                                              features.contains(dev.sanskrit.shiksha.SemanticFeature.BAHUVACANA)) 1 else 0)
