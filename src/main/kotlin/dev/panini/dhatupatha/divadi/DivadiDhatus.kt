...
object DivadiDhatus {
    val all: List<dev.panini.dhatupatha.Dhatu> =
        _root_ide_package_.dev.panini.dhatupatha.dhatuPatha(dev.panini.dhatupatha.Gana.DIVADI) {
            dhatu(
            ...
            dhatu(
                ...
                "खिद्",
                "दैन्ये",
                "खिन्न होना, दुःख सहन करना, दीनता प्रकट करना",
                "to be sad, to be displeased, to be distressed",
                PadaType.ATMANEPADA,
                ItStatus.ANIT,
                Karmatva.AKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "रुध्",
                "कामे",
                "कृपालु होना, दया करना, अनुमोदन देना, शोक करना, रोना, चाहना",
                "to pitty, to be compassionate, to agree, to approve, to mourn, to grieve, to desire, to wish",
                PadaType.ATMANEPADA,
                ItStatus.ANIT,
                Karmatva.AKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "युज्",
                "समाधौ",
                "चित्त स्थिर करना, मन को रोकना",
                "to concentrate, to focus, to abstain from senses, to meditate",
                PadaType.ATMANEPADA,
                ItStatus.ANIT,
                Karmatva.AKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "व्यध्",
                "ताडने",
                "मारना, पीटना, दुःख देना, चुभाना, छेदना",
                "to strike,to hurt,to stab,to pierce, to hit, to cause pain, to pinch",
                PadaType.PARASMAIPADA,
                ItStatus.ANIT,
                Karmatva.SAKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "पुष्टौ",
                "पालन करना, पोषण करना",
                "to nurture, to nourish, to maintain,to promote,to bring up,to support",
                PadaType.PARASMAIPADA,
                ItStatus.ANIT,
                Karmatva.AKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "दुष्",
                "वैकृत्ये",
                "दुःखित होना या करना, दूषित करना",
            ...
            dhatu(
                ...
                "रध्",
                "हिंसासंराद्ध्योः",
                "मार डालना, दुःख देना, पक्व होना या पकना",
                "to kill,to injure,to hurt, to be ripen, to be ready",
                PadaType.PARASMAIPADA,
                ItStatus.VET,
                Karmatva.SAKARMAKA,
                Accent.UDATTA,
            ...
            dhatu(
                ...
                "नश्",
                "अदर्शने",
                "अदर्शन होना, नाश होना, दिखाई न देना",
            ...
            dhatu(
                ...
                "तृप्",
                "प्रीणने",
                "तृप्त होना या करना, प्रसन्न होना या करना",
                "to satisfy, to be satisfied, to please, to be pleased",
                PadaType.PARASMAIPADA,
                ItStatus.VET,
                Karmatva.SAKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "श्रम्",
                "तपसि खेदे च",
                "तपश्चर्या करना, व्रत करना, थकना, दुःखित होना",
                "to do penance, to be fatigued, to be tired",
                PadaType.PARASMAIPADA,
                ItStatus.SET,
                Karmatva.SAKARMAKA,
                Accent.UDATTA,
            ...
            dhatu(
                ...
                "युस्",
                "विभागे",
                "अलग करना, विभाग करना, जलाना, भूनना, दग्ध करना",
                "to split, to divide, to separate, to partition, to burn, to fry",
                PadaType.PARASMAIPADA,
                ItStatus.SET,
                Karmatva.SAKARMAKA,
                Accent.UDATTA,
