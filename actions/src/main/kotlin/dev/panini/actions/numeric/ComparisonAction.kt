...
class ComparisonAction(
    ...
    companion object {
        val GreaterThan = ComparisonAction(ComparisonType.GREATER_THAN)
        val LessThan = ComparisonAction(ComparisonType.LESS_THAN)
        val Equals = ComparisonAction(ComparisonType.EQUALS)
    }
}
