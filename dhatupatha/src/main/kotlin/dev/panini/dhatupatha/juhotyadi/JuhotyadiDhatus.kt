    ...
    val all: List<dev.panini.dhatupatha.Dhatu> =
        dhatuPatha(DhatuGana.JUHOTYADI) {
            dhatu(
                ...
                "हु",
                "हु",
                "दानादानयोः आदाने प्रीणने च",
                "देना, यज्ञ करना, खाना, लेना, भक्षण करना, ग्रहण करना",
                "to sacrifice,to eat, to consume",
            ...
            dhatu(
                ...
                "पॄ",
                "पालनपूरणयोः",
                "पालन करना, पोषण करना, पूर्ण करना, भरना",
                "to take care, to nurture, to nourish, o provide, to fill",
                PadaType.PARASMAIPADA,
                ItStatus.SET,
                Karmatva.SAKARMAKA,
                Accent.UDATTA,
            ...
            dhatu(
                ...
                "मा",
                "माने शब्दे च",
                "नापना, तौलना, मेमियाना",
                "to measure,to weigh,to limit,to compare in size,to shine,to appear,to sound",
                PadaType.ATMANEPADA,
                ItStatus.ANIT,
                Karmatva.SAKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "निज्",
                "शौचपोषणयोः",
                "शुद्ध करना, स्वच्छ करना, पालन करना",
                "to wash,to purify,to cleanse,to nourish, to support",
                PadaType.UBHAYAPADA,
                ItStatus.ANIT,
                Karmatva.SAKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "घृ",
                "क्षरणदीप्त्योः",
                "टपकना, क्षरित होना, चमकना, प्रकाशित होना",
                "to sprinkle,to ooze out, to drip, to shine,to glow",
                PadaType.PARASMAIPADA,
                ItStatus.ANIT,
                Karmatva.SAKARMAKA,
                Accent.ANUDATTA,
            ...
            dhatu(
                ...
                "भस्",
                "भर्त्सनदीप्त्योः",
                "भयभीत करना, दोष लगाना, चमकना",
                "to frighten, to censure,to blame,to shine, to insult",
                PadaType.PARASMAIPADA,
                ItStatus.SET,
                Karmatva.AKARMAKA,
                Accent.UDATTA,
